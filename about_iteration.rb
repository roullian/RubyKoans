...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # It adds the specific element into the array
  end
  ...
  #
  # Julian : I see two main reasons
  # 1) It limits the range of use of the file to the following code
  # 2) It specifies what we intend to do with that file
